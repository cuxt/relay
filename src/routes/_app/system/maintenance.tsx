...
export const Route = createFileRoute('/_app/system/maintenance')({
...
function SystemMaintenance() {
  ...
  return (
    <div className="h-full space-y-8">
      <div>
        <h1 className="text-2xl font-semibold">系统维护</h1>
        <p className="text-sm text-muted-foreground mt-1">查看系统运行状态</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="flex items-center gap-4 p-6 rounded-lg border border-border">
